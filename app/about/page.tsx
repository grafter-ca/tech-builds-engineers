...
import { InstructorList, TeamMembers } from "@/constants"; 
...
export default function AboutPage() {
  ...
  return (
    ...
    <main className="space-y-24">
      ...
      <section
        ref={heroRef}
        className="relative w-full h-[60vh] mt-21 flex items-center justify-center bg-[url('/img/engineering-image.jpeg')] bg-cover bg-center text-white"
      >
