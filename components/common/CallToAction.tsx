...
const CallToAction = () => {
  return (
    <article className="flex flex-col items-center justify-center max-w-7xl mx-auto space-y-4 px-10 py-20 rounded-none md:rounded-xl lg:rounded-full mb-20 bg-[#A8C7FF]">
